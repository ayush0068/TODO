...
export default function Home() {
  ...
  const inp = (extra = {}) => ({
    ...
    borderColor: d ? "rgba(255,255,255,0.09)" : "rgba(15,23,42,0.12)",
    background: d ? "rgba(255,255,255,0.03)" : "rgba(15,23,42,0.025)",
  ...
  const onFocus = (e) => {
    ...
    e.target.style.background = d ? "rgba(99,102,241,0.04)" : "rgba(99,102,241,0.02)";
  };
  const onBlur = (e) => {
    e.target.style.borderColor = d ? "rgba(255,255,255,0.09)" : "rgba(15,23,42,0.12)";
    e.target.style.boxShadow = "none";
    e.target.style.background = d ? "rgba(255,255,255,0.03)" : "rgba(15,23,42,0.025)";
  };
  ...
  const HeroSection = () => (
    <div style={{
      ...
      <div style={{ position:"absolute",top:"-100px",left:"-60px",width:"400px",height:"400px",borderRadius:"50%",pointerEvents:"none",
        background: d?"radial-gradient(circle,rgba(99,102,241,0.13) 0%,transparent 65%)":"radial-gradient(circle,rgba(99,102,241,0.08) 0%,transparent 65%)" }} />
      <div style={{ position:"absolute",bottom:"-60px",right:"-30px",width:"300px",height:"300px",borderRadius:"50%",pointerEvents:"none",
        background: d?"radial-gradient(circle,rgba(14,165,233,0.09) 0%,transparent 65%)":"radial-gradient(circle,rgba(14,165,233,0.06) 0%,transparent 65%)" }} />

      <div style={{ position:"relative", zIndex:2 }}>
        {/* Badge */}
        <div style={{ display:"inline-flex",alignItems:"center",gap:"8px",padding:"5px 13px",borderRadius:"100px",width:"fit-content",marginBottom: m?"18px":"28px",
          ...
          <span style={{ fontSize:"11.5px",fontWeight:600,color:"#818cf8",letterSpacing:"0.2px",whiteSpace:"nowrap" }}>MongoDB Atlas sync enabled</span>
        </div>

        {/* Heading */}
        <h1 style={{ fontFamily:"'Playfair Display',serif", fontSize: m?"2rem":"clamp(2.2rem,3vw,3rem)", fontWeight:800,lineHeight:1.1,marginBottom:"14px",color: d?"#f1f5f9":"#0f172a" }}>
          Your tasks,<br />
        ...
        <p style={{ fontSize: m?"13.5px":"14.5px",lineHeight:1.75,marginBottom: m?"20px":"34px",color: d?"#94a3b8":"#64748b",maxWidth:"400px" }}>
          A clean, fast task manager for developers and teams.
          Create, search, and track — all synced securely to the cloud.
        </p>

        {/* Features */}
        <div style={{ display:"flex",flexDirection:"column",gap: m?"10px":"13px",marginBottom: m?"20px":"36px" }}>
          {features.map(f => (
            <div key={f.text} style={{ display:"flex",alignItems:"center",gap:"12px" }}>
              <div style={{ width:"32px",height:"32px",borderRadius:"9px",flexShrink:0,display:"flex",alignItems:"center",justifyContent:"center",
                background: d?"rgba(255,255,255,0.04)":"rgba(15,23,42,0.04)",
                border:`1px solid ${d?"rgba(255,255,255,0.07)":"rgba(15,23,42,0.07)"}` }}>
                <i className={`bi ${f.icon}`} style={{ color:f.color,fontSize:"13px" }} />
              </div>
              <span style={{ fontSize:"13px",color: d?"#94a3b8":"#64748b",fontWeight:500 }}>{f.text}</span>
            </div>
          ))}
        </div>
        ...
        <div style={{ display:"flex",alignItems:"center",gap:0,flexWrap:"wrap" }}>
          {["React","Node.js","MongoDB","JWT"].map((t,i,arr) => (
            <span key={t} style={{ fontSize:"10.5px",fontWeight:700,letterSpacing:"0.4px",color: d?"#334155":"#94a3b8",
              paddingRight: i<arr.length-1?"14px":"0", marginRight: i<arr.length-1?"14px":"0",
              borderRight: i<arr.length-1?`1px solid ${d?"rgba(255,255,255,0.07)":"rgba(15,23,42,0.08)"}`:undefined }}>
              {t}
            </span>
          ))}
        </div>
  ...
  const FormSection = () => (
    <div style={{
      ...
      padding: m ? "2rem 1.5rem 3rem" : "2.5rem 3rem",
      position:"relative", overflow:"hidden",
      background: d ? "#0d0d1e" : "#ffffff",
      ...(m ? {} : { flex:"0 0 50%" }),
    }}>
      {/* Corner glows */}
      <div style={{ position:"absolute",top:"-80px",right:"-80px",width:"300px",height:"300px",borderRadius:"50%",pointerEvents:"none",
        background: d?"radial-gradient(circle,rgba(99,102,241,0.07) 0%,transparent 65%)":"radial-gradient(circle,rgba(99,102,241,0.04) 0%,transparent 65%)" }} />
      <div style={{ position:"absolute",bottom:"-60px",left:"-40px",width:"240px",height:"240px",borderRadius:"50%",pointerEvents:"none",
        background: d?"radial-gradient(circle,rgba(14,165,233,0.06) 0%,transparent 65%)":"radial-gradient(circle,rgba(14,165,233,0.04) 0%,transparent 65%)" }} />

      {/* Top line — only desktop */}
      {!m && <div style={{ position:"absolute",top:0,left:0,right:0,height:"2px",background:"linear-gradient(90deg,transparent,#6366f1 30%,#0ea5e9 70%,transparent)" }} />}
          ...
          <div>
            <div style={{ display:"flex",alignItems:"center",gap:"12px",marginBottom:"20px" }}>
              <div style={{ width:"40px",height:"40px",borderRadius:"12px",flexShrink:0,display:"flex",alignItems:"center",justifyContent:"center",
                ...
                <i className="bi bi-person-circle" style={{ color:"#818cf8",fontSize:"19px" }} />
              </div>
              <div>
                <p style={{ fontSize:"10px",fontWeight:700,letterSpacing:"1px",textTransform:"uppercase",color:"#6366f1",margin:0 }}>Welcome back</p>
                <h2 style={{ fontFamily:"'Playfair Display',serif",fontSize:"20px",fontWeight:700,color: d?"#f1f5f9":"#0f172a",margin:0,lineHeight:1.2 }}>Sign in to continue</h2>
              </div>
            </div>
            <div style={{ height:"1px",background:`linear-gradient(90deg,${d?"rgba(99,102,241,0.3)":"rgba(99,102,241,0.2)"} 0%,transparent 100%)`,marginBottom:"20px" }} />
            ...
            <form onSubmit={handleLogin} noValidate style={{ display:"flex",flexDirection:"column",gap:"14px" }}>
              <div>
                ...
                <div style={{ position:"relative" }}>
                  ...
                  <input type="email" style={inp()} placeholder="you@example.com" value={lForm.email} onChange={setL("email")} onFocus={onFocus} onBlur={onBlur} autoComplete="email" />
                </div>
                {errLine(lErr.email)}
              </div>
              <div>
                ...
                <div style={{ position:"relative" }}>
                  ...
                  <input type={lShowPw?"text":"password"} style={inp({ paddingRight:"2.4rem" })} placeholder="••••••••" value={lForm.password} onChange={setL("password")} onFocus={onFocus} onBlur={onBlur} autoComplete="current-password" />
              ...
              <button type="submit" disabled={lLoading} style={{ width:"100%",padding:"12.5px",borderRadius:"12px",border:"none",marginTop:"4px",background:"linear-gradient(135deg,#6366f1 0%,#0ea5e9 100%)",color:"white",fontSize:"13.5px",fontWeight:700,cursor:lLoading?"not-allowed":"pointer",display:"flex",alignItems:"center",justifyContent:"center",gap:"8px",fontFamily:"'DM Sans',sans-serif",boxShadow:"0 6px 22px rgba(99,102,241,0.38)",transition:"transform 0.15s,box-shadow 0.15s" }}
                ...
                {lLoading ? <span style={{ width:"15px",height:"15px",borderRadius:"50%",border:"2px solid rgba(255,255,255,0.3)",borderTopColor:"white",display:"inline-block",animation:"spin 0.7s linear infinite" }} /> : <><i className="bi bi-box-arrow-in-right" style={{ fontSize:"15px" }} />Sign In</>}
              </button>
            </form>
          ...
          <div>
            <div style={{ display:"flex",alignItems:"center",gap:"12px",marginBottom:"18px" }}>
              <div style={{ width:"40px",height:"40px",borderRadius:"12px",flexShrink:0,display:"flex",alignItems:"center",justifyContent:"center",
                ...
                border:`1px solid ${d?"rgba(14,165,233,0.2)":"rgba(14,165,233,0.15)"}` }}>
              ...
              <div>
                ...
                <h2 style={{ fontFamily:"'Playfair Display',serif",fontSize:"20px",fontWeight:700,color: d?"#f1f5f9":"#0f172a",margin:0,lineHeight:1.2 }}>Create your account</h2>
              </div>
            </div>
            <div style={{ height:"1px",background:`linear-gradient(90deg,${d?"rgba(14,165,233,0.3)":"rgba(14,165,233,0.2)"} 0%,transparent 100%)`,marginBottom:"18px" }} />
            ...
            <form onSubmit={handleRegister} noValidate style={{ display:"flex",flexDirection:"column",gap:"12px" }}>
              <div>
                ...
                <div style={{ position:"relative" }}>
                  ...
                  <input type="text" style={inp()} placeholder="John Doe" value={rForm.name} onChange={setR("name")} onFocus={onFocus} onBlur={onBlur} autoComplete="name" />
                </div>
                {errLine(rErr.name)}
              </div>
              <div>
                ...
                <div style={{ position:"relative" }}>
                  <i className="bi bi-envelope" style={iconSt} />
                  <input type="email" style={inp()} placeholder="you@example.com" value={rForm.email} onChange={setR("email")} onFocus={onFocus} onBlur={onBlur} autoComplete="email" />
                </div>
                {errLine(rErr.email)}
              </div>
              <div>
                ...
                <div style={{ position:"relative" }}>
                  <i className="bi bi-lock" style={iconSt} />
                  <input type={rShowPw?"text":"password"} style={inp({ paddingRight:"2.4rem" })} placeholder="Min. 6 characters" value={rForm.password} onChange={setR("password")} onFocus={onFocus} onBlur={onBlur} autoComplete="new-password" />
                    ...
                    <div style={{ display:"flex",gap:"3px",marginBottom:"4px" }}>
                      {[1,2,3,4].map(n => (
                        <div key={n} style={{ flex:1,height:"2.5px",borderRadius:"10px",transition:"background 0.3s",
                          background: pwStr(rForm.password)>=n ? strMeta[pwStr(rForm.password)].color : d?"rgba(255,255,255,0.07)":"rgba(15,23,42,0.08)" }} />
                      ))}
                    </div>
              ...
              <button type="submit" disabled={rLoading} style={{ width:"100%",padding:"12.5px",borderRadius:"12px",border:"none",marginTop:"2px",background:"linear-gradient(135deg,#0ea5e9 0%,#6366f1 100%)",color:"white",fontSize:"13.5px",fontWeight:700,cursor:rLoading?"not-allowed":"pointer",display:"flex",alignItems:"center",justifyContent:"center",gap:"8px",fontFamily:"'DM Sans',sans-serif",boxShadow:"0 6px 22px rgba(14,165,233,0.32)",transition:"transform 0.15s,box-shadow 0.15s" }}
                ...
                {rLoading ? <span style={{ width:"15px",height:"15px",borderRadius:"50%",border:"2px solid rgba(255,255,255,0.3)",borderTopColor:"white",display:"inline-block",animation:"spin 0.7s linear infinite" }} /> : <><i className="bi bi-rocket-takeoff" style={{ fontSize:"15px" }} />Create Account</>}
              </button>
            </form>
