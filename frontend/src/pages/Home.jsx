              ...
              <div>
                ...
                <div style={{ display:"flex",alignItems:"center",gap:"12px",marginBottom:"22px" }}>
                  ...
                  <div>
                    ...
                    <h2 style={{ fontFamily:"'Playfair Display',serif",fontSize:"22px",fontWeight:700,color: d?"#f1f5f9":"#0f172a",margin:0,lineHeight:1.2 }}>Sign in to continue</h2>
                  </div>
                </div>
              ...
              <div>
                <div style={{ display:"flex",alignItems:"center",gap:"12px",marginBottom:"20px" }}>
                  ...
                  <div>
                    ...
                    <h2 style={{ fontFamily:"'Playfair Display',serif",fontSize:"22px",fontWeight:700,color: d?"#f1f5f9":"#0f172a",margin:0,lineHeight:1.2 }}>Create your account</h2>
                  </div>
                </div>
